            ...
            <tbody>
              ...
              <span className="btn  ml-56">
                <tr className=" bg-white border-b dark:bg-blue-400 dark:border-black">
                  <td
                    scope="row"
                    className="  mx-5 px-6 py-5 font-medium text-gray z-900 dark:text-white whitespace-nowrap"
                  >
                    <button
                      type="text"
                      className="w-full
